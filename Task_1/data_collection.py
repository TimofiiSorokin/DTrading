...
# I had a problem with getting the value, but if we use developer tools carefully we can find a better link.
# I'll show you the main idea.
# import requests
#
# url = 'https://epbets.ueex.com.ua/public/PublicHandler.ashx?CommandName=jPositions&id_auc=3294127&info=Y&lan=ua' \
#       '&fl_FullNumber=&fl_Direction=&fl_Owner=&fl_Goods=&fl_DeliveryType=&empty_filter=Y '
